 ...
 * 新动态页面
 */
public class ImMsgLikeNewActivity extends AbsActivity {


    public static void forward(Context context) {
        context.startActivity(new Intent(context, ImMsgLikeNewActivity.class));
    }
    ...
    protected void main() {
        ...
        mRefreshView.setDataHelper(new CommonRefreshView.DataHelper<VideoImMsgBean>() {
            ...
            public void loadData(int p, HttpCallback callback) {
                ImHttpUtil.getImLikeLists(p, callback);
            }
