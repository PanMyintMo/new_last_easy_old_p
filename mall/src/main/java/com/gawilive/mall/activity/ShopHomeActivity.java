...
import com.gawilive.mall.custom.ShopIndicatorTitle;
import com.gawilive.mall.views.ShopHomeMyViewHolder;
import com.gawilive.mall.views.ShopHomePlatViewHolder;
...
public class ShopHomeActivity extends AbsActivity implements View.OnClickListener {
    ...
    protected void main() {
        ...
        int textColor = ContextCompat.getColor(mContext, com.gawilive.common.R.color.textColor);
//        mHeader = findViewById(com.gawilive.common.R.id.header);
