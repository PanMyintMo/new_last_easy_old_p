...
import com.gawilive.mall.dialog.GoodsPayDialogFragment;
...
public class BuyerOrderDetailActivity extends AbsActivity {
    ...
    protected void main() {
        ...
        btnWuliu = findViewById(R.id.btn_wuliu);
        ...
        MallHttpUtil.getBuyerOrderDetail(mOrderId, new HttpCallback() {
            ...
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0 && info.length > 0) {
                    ...
                    // 查看物流
                    btnWuliu.setOnClickListener(v -> LogisticsDetailsActivity.start(mContext,mOrderInfo.getString("express_number")));
                }
            }
        });
    }
...
//        WebViewActivity.forward(mContext, url);
        // 物流单号
        String billNumber = mOrderInfo.getString("express_number");
        LogisticsDetailsActivity.start(this, billNumber);
    }
