...
import com.gawilive.mall.adapter.GoodsCommentAdapter;
import com.gawilive.mall.adapter.GoodsDetailAdapter;
import com.gawilive.mall.adapter.GoodsTitleAdapter;
import com.gawilive.mall.bean.GoodsChooseSpecBean;
import com.gawilive.mall.bean.GoodsCommentBean;
import com.gawilive.mall.bean.GoodsSpecBean;
import com.gawilive.mall.dialog.GoodsCertDialogFragment;
import com.gawilive.mall.dialog.GoodsShareDialogFragment;
import com.gawilive.mall.dialog.GoodsSpecDialogFragment;
        ...
        ImHttpUtil.getImUserInfo(mToUid, new HttpCallback() {
            ...
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0 && info.length > 0) {
                    ...
                    if (bean != null) {
                        ChatActivity.start(mContext, bean);
                    }
                }
            }
        });
