package com.gawilive.mall.http;
...
public class MallHttpUtil {
     ...
     * 获取省市区-新
     */
    public static void getAddress(HttpCallback callback) {
        HttpClient.getInstance().post("Logistics.openDownCity", MallHttpConsts.openDownCity)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
     ...
     * @param callback
     */
    public static void openFindTrack(String billNumber, HttpCallback callback) {
        CommonAppConfig appConfig = CommonAppConfig.getInstance();
        String uid = appConfig.getUid();
        String token = appConfig.getToken();
        HttpClient.getInstance().post("Logistics.openFindTrack", MallHttpConsts.GET_BUYER_ORDER_DETAIL)
                .params("uid", uid)
                .params("token", token)
                .params("billCode", billNumber)
                .execute(callback);
    }
     ...
     * @param callback
     */
    public static void openFindOrderStatus(String billNumber, HttpCallback callback) {
        CommonAppConfig appConfig = CommonAppConfig.getInstance();
        String uid = appConfig.getUid();
        String token = appConfig.getToken();
        HttpClient.getInstance().post("Logistics.openFindOrderStatus", MallHttpConsts.GET_BUYER_ORDER_DETAIL)
                .params("uid", uid)
                .params("token", token)
                .params("billCode", billNumber)
                .execute(callback);
     ...
     * 新-卖家 发货填写物流单号
     */
    public static void openBuildOrder(String p_sender_name,
                                      String p_sender_mobile,
                                      String p_sender_prov,
                                      String p_sender_city,
                                      String p_sender_area,
                                      String p_sender_address,
                                      String p_peceiver_name,
                                      String p_peceiver_mobile,
                                      String p_peceiver_prov,
                                      String p_peceiver_city,
                                      String p_peceiver_area,
                                      String p_goods_name,
                                      String p_goodsfee,
                                      HttpCallback callback
    ) {
        ...
        String uid = appConfig.getUid();
        String token = appConfig.getToken();
        HttpClient.getInstance().post("Logistics.openBuildOrder", MallHttpConsts.openBuildOrder)
                .params("uid", uid)
                .params("token", token)
                .params("p_sender_name", p_sender_name)
                .params("p_sender_mobile", p_sender_mobile)
                .params("p_sender_prov", p_sender_prov)
                .params("p_sender_city", p_sender_city)
                .params("p_sender_area", p_sender_area)
                .params("p_sender_address", p_sender_address)
                .params("p_peceiver_name", p_peceiver_name)
                .params("p_peceiver_mobile", p_peceiver_mobile)
                .params("p_peceiver_prov", p_peceiver_prov)
                .params("p_peceiver_city", p_peceiver_city)
                .params("p_peceiver_area", p_peceiver_area)
                .params("p_goods_name", p_goods_name)
                .params("p_goodsfee", p_goodsfee)
                .execute(callback);
    }
     ...
     * @param callback
     */
    public static void getMerchantAddress(HttpCallback callback) {
        CommonAppConfig appConfig = CommonAppConfig.getInstance();
        String token = appConfig.getToken();
        HttpClient.getInstance().post("User.getMerchantAddress", MallHttpConsts.openBuildOrder)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", token)
                .execute(callback);
    }
     ...
     * @param callback
     */
    public static void updateMerchantAddress(String province,String city,String area,String address,String phone,String sendName,HttpCallback callback) {
        CommonAppConfig appConfig = CommonAppConfig.getInstance();
        String token = appConfig.getToken();
        HttpClient.getInstance().post("User.updateMerchantAddress", MallHttpConsts.updateMerchantAddress)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", token)
                .params("province", province)
                .params("city", city)
     ...
     * @param callback
     */
    public static void shopUserInfo(String uid, HttpCallback callback) {
        CommonAppConfig appConfig = CommonAppConfig.getInstance();
        String token = appConfig.getToken();
        HttpClient.getInstance().post("User.userInfo", MallHttpConsts.openBuildOrder)
                .params("uid", uid)
                .params("token", token)
                .execute(callback);
    }
