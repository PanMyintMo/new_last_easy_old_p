...
public class MallHttpConsts {
    ...
    public static final String openBuildOrder = "openBuildOrder";

    public static final String shop_user_info = "openBuildOrder";
    ...
    public static final String openDownCity = "openDownCity";

    public static final String updateMerchantAddress = "updateMerchantAddress";
