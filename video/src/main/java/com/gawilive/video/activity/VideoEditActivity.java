...
import com.gawilive.video.views.VideoEditCutViewHolder;
import com.gawilive.video.views.VideoEditFilterViewHolder;
import com.gawilive.video.views.VideoEditMusicViewHolder;
import com.gawilive.video.views.VideoMusicViewHolder;
import com.gawilive.video.views.VideoProcessViewHolder;
...
public class VideoEditActivity extends AbsActivity implements
    ...
    public void onGenerateComplete(TXVideoEditConstants.TXGenerateResult result) {
        ...
        if (result.retCode == TXVideoEditConstants.GENERATE_RESULT_OK) {
            if (mUseWaterMark) {
                //L.e(TAG, "Watermark video generation ends------->");
                generateFinish();
            } else {
               // L.e(TAG, "Normal video generation ends------->");
                mUseWaterMark = true;
                startGenerateVideo();
            }
        } else {
    ...
    private void generateFinish() {
      ...
      //  L.e(TAG, "onGenerateComplete------->End of video generation");
        if (mVideoGenerateViewHolder != null) {
...
//        });
    ...
    private void startGenerateVideo() {
      //  L.e(TAG, "startGenerateVideo------->Generate video---watermark----->" + mUseWaterMark);
        if (mVideoEditer == null) {
            return;
        }
        if (mUseWaterMark) {
    ...
    public void onProcessComplete(TXVideoEditConstants.TXGenerateResult result) {
        if (result.retCode == TXVideoEditConstants.GENERATE_RESULT_OK) {
         ...
         //   L.e(TAG, "Video preprocessing error------->" + result.descMsg);
            processFailed();
        }
    }
    ...
    private void processCompleted() {
        //L.e(TAG, "Video preprocessing----->Finish");
        if (mVideoProcessViewHolder != null) {
