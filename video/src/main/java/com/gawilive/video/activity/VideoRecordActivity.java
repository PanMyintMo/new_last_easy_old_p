...
import com.gawilive.common.custom.DrawableRadioButton2;
...
import com.gawilive.video.custom.RecordProgressView;
        ...
        TXRecordCommon.ITXVideoRecordListener //视频录制进度回调
{
    ...
    private static final int MAX_DURATION = 1800000;//最大录制时间180s
    //按钮动画相关
                ...
                .forResult(new OnResultCallbackListener<LocalMedia>() {
                    ...
                    public void onResult(ArrayList<LocalMedia> result) {
                        if (result.size() > 0) {
                            ...
                            mDuration = localMedia.getDuration();
        ...
        mRecorder.setVideoProcessListener(new com.tencent.ugc.TXUGCRecord.VideoCustomProcessListener() {
            ...
            public int onTextureCustomProcess(int texture, int width, int height) {
                int textureId = TiSDKManager.getInstance().renderTexture2D(texture,
                        width, height, TiRotation.CLOCKWISE_ROTATION_0, mFrontCamera);
                return textureId;
            }
