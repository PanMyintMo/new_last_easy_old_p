...
import static com.gawilive.main.R.string.main_active;
...
import com.gawilive.live.activity.LiveReportActivity;
import com.gawilive.live.activity.UserHomeBgActivity;
...
import com.gawilive.live.presenter.LiveRoomCheckLivePresenter;
import com.gawilive.live.presenter.UserHomeSharePresenter;
import com.gawilive.live.views.LiveRecordViewHolder;
...
import com.gawilive.mall.views.PayPubViewHolder;
...
public class UserHomeViewHolder extends AbsLivePageViewHolder implements LiveShareDialogFragment.ActionListener {
    ...
    public void init() {
        ...
        mActiveString = WordUtil.getString(main_active);
    ...
    private void forwardMsg() {
        if (mSearchUserBean != null) {
            ChatActivity.start(mContext,mSearchUserBean);
        }
    }
