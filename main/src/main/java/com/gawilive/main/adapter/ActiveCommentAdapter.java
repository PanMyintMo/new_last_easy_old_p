...
import com.gawilive.main.bean.ActiveCommentBean;
        ...
        mLikeClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(uid) && uid.equals(CommonAppConfig.getInstance().getUid())) {
                    ToastUtil.show(com.gawilive.video.R.string.video_comment_cannot_self);
                    return;
                }
...
//                    mName.setTag(R.id.avatar, u.getId());
    ...
    class ChildVh extends Vh {
        ...
        public ChildVh(View itemView) {
            super(itemView);
            mBtnGroup = itemView.findViewById(com.gawilive.video.R.id.btn_group);
            mBtnExpand = itemView.findViewById(com.gawilive.video.R.id.btn_expand);
            mBtnbCollapsed = itemView.findViewById(com.gawilive.video.R.id.btn_collapsed);
