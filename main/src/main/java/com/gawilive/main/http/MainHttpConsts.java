...
public class MainHttpConsts {
    ...
    public  static final String createPin="Pin.createPin";

    public static final String coinTransfer="Cointransfer.coinTransfer";
    ...
    public static final String SETUP_PAY_PASS = "paypwd";

    public static final String getTurntable = "getTurntable";

    public static final String LotteryRules = "LotteryRules";

    public static final String winningNumbers = "winningNumbers";

    public static final String drawWinLottery = "drawWinLottery";

    public static final String drawWinTrunLog = "drawWinTrunLog";

    public static final String getUserOpenWinLog = "getUserOpenWinLog";

    public static final String getUserWinTrun = "getUserWinTrun";

    public static final String getRedSocreInfo = "getRedSocreInfo";

    public static final String getGreenSocreInfo = "getGreenSocreInfo";

    public static final String getAuth = "getAuth";

    public static final String getPublicConfig = "getPublicConfig";
