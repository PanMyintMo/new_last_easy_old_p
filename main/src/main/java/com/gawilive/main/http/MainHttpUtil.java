...
public class MainHttpUtil {
    ...
    public static void loginByGoogle(String provider, String idToken, HttpCallback callback) {
        HttpClient.getInstance()
                .postRequest("social/login", MainHttpConsts.SOCIAL_LOGIN)
                .params("provider", provider)
                .params("id_token", idToken) // Pass the ID token
                .execute(callback);
    }
    ...
    public static void createPin(String createPin, String confirmPin, HttpCallback callback) {

//        String uid =CommonAppConfig.getInstance().getUid();
//        String token=CommonAppConfig.getInstance().getToken();
//        Log.d("HttpRequest", "Parameters: uid=" + uid +"token is " + token +  ", createdPin=" + createPin + ", confirmPin=" + confirmPin);

        HttpClient.getInstance().post("Pin.createPin", MainHttpConsts.createPin)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("createdPin", createPin)
                .params("confirmPin", confirmPin)
                .execute(callback);
    }


    //transfer diamond
    public static void diamondTransfer(int receiver_id, int amount,String created_pin, HttpCallback callback) {

        String uid =CommonAppConfig.getInstance().getUid();
        String token=CommonAppConfig.getInstance().getToken();
        Log.d("HttpRequest", "Parameters: uid=" + uid +"token is " + token +  ", cointransfter=" + receiver_id + ", confirmPin=" + amount + "Create Pin is " + created_pin);

        HttpClient.getInstance().post("Cointransfer.coinTransfer", MainHttpConsts.coinTransfer)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("receiver_id", receiver_id)
                .params("created_pin",created_pin)
    ...
    public static void doCash(String votes, String accountId, HttpCallback callback) {
        HttpClient.getInstance().get("User.setCash", MainHttpConsts.DO_CASH)
                ...
                .params("purse_uid", accountId)//账号ID
                .execute(callback);
    }
...
//                .params("old_price", goodsBean.getPriceOrigin())
    ...
    public static void getTurntable(HttpCallback callback) {
        HttpClient.getInstance().post("Turntable.getTurntable", MainHttpConsts.getTurntable)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * @param callback
     */
    public static void LotteryRules(HttpCallback callback) {
        HttpClient.getInstance().post("Turntable.LotteryRules", MainHttpConsts.LotteryRules)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * @param callback
     */
    public static void winningNumbers(String number, String win_num_score_id, String win_cycle_id, String cycle, HttpCallback callback) {
        HttpClient.getInstance().post("Turntable.winningNumbers", MainHttpConsts.winningNumbers)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("number", number)
                .params("win_num_score_id", win_num_score_id)
                .params("win_cycle_id", win_cycle_id)
                .params("cycle", cycle)
                .execute(callback);
    }
     ...
     * @param callback
     */
    public static void drawWinLottery(HttpCallback callback) {
        HttpClient.getInstance().get("Turntable.drawWinLottery", MainHttpConsts.drawWinLottery)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * @param callback
     */
    public static void getDrawWinTrunLog(HttpCallback callback) {
        HttpClient.getInstance().get("Turntable.drawWinTrunLog", MainHttpConsts.drawWinTrunLog)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * @param callback
     */
    public static void getUserOpenWinLog(HttpCallback callback){
        HttpClient.getInstance().get("Turntable.getUserOpenWinLog", MainHttpConsts.getUserOpenWinLog)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * @param callback
     */
    public static void getUserWinTrue(HttpCallback callback){
        HttpClient.getInstance().get("Turntable.getUserWinTrun", MainHttpConsts.drawWinTrunLog)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }

    public static void getRedScore(HttpCallback callback) {
        HttpClient.getInstance().get("User.getRedSocreInfo", MainHttpConsts.getRedSocreInfo)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }

    public static void getGreenScore(HttpCallback callback) {
        HttpClient.getInstance().get("User.getGreenSocreInfo", MainHttpConsts.getGreenSocreInfo)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void getAuth(HttpCallback callback){
        HttpClient.getInstance().get("Auth.getAuth", MainHttpConsts.getAuth)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    ...
    // 绿色积分
    public static void getGreenScoreRule(HttpCallback callback){
        HttpClient.getInstance().get("User.getGreenScoreRule", MainHttpConsts.getAuth)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    // 红色积分
    public static void getRedScoreRule(HttpCallback callback){
        HttpClient.getInstance().get("User.getRedScoreRule", MainHttpConsts.getAuth)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * @param callback
     */
    public static void getPublicConfig(HttpCallback callback){
        HttpClient.getInstance().get("User.getPublicConfig", MainHttpConsts.getPublicConfig)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
