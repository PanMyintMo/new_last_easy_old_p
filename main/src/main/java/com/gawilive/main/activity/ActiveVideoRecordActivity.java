...
import com.gawilive.video.custom.VideoRecordBtnView;
...
//        findViewById(R.id.btn_re_record).setOnClickListener(this);
    ...
    public void onRecordEvent(int event, Bundle bundle) {
        if (event == TXRecordCommon.EVT_CAMERA_CANNOT_USE) {
            ToastUtil.show(com.gawilive.video.R.string.video_record_camera_failed);
        } else if (event == TXRecordCommon.EVT_MIC_CANNOT_USE) {
            ToastUtil.show(com.gawilive.video.R.string.video_record_audio_failed);
        }
    }
...
//    }
    ...
    private void startRecord() {
        if (mRecorder != null) {
            ...
            int result = mRecorder.startRecord(mVideoPath, CommonAppConfig.VIDEO_RECORD_TEMP_PATH, null);//Empty means no video cover is required to be generated
            if (result != TXRecordCommon.START_RECORD_OK) {
                if (result == TXRecordCommon.START_RECORD_ERR_NOT_INIT) {
                    ToastUtil.show(com.gawilive.video.R.string.video_record_tip_1);
                } else if (result == TXRecordCommon.START_RECORD_ERR_IS_IN_RECORDING) {
                    ToastUtil.show(com.gawilive.video.R.string.video_record_tip_2);
                } else if (result == TXRecordCommon.START_RECORD_ERR_VIDEO_PATH_IS_EMPTY) {
                    ToastUtil.show(com.gawilive.video.R.string.video_record_tip_3);
                } else if (result == TXRecordCommon.START_RECORD_ERR_API_IS_LOWER_THAN_18) {
                    ToastUtil.show(com.gawilive.video.R.string.video_record_tip_4);
                } else if (result == TXRecordCommon.START_RECORD_ERR_LICENCE_VERIFICATION_FAILED) {
                    ToastUtil.show(com.gawilive.video.R.string.video_record_tip_5);
                }
                return;
            }
        }
    ...
    /**
     *Button recording animation starts
     */
    ...
    /**
     *Button recording animation stops
     */
    ...
    /**
     * Display a pop-up window in progress when recording ends
     */
