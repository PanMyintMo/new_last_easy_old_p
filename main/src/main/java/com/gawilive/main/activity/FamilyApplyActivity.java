...
public class FamilyApplyActivity extends AbsActivity implements View.OnClickListener {
    ...
    private void chooseImage() {
        DialogUitl.showStringArrayDialog(mContext, new Integer[]{com.gawilive.mall.R.string.alumb, com.gawilive.mall.R.string.camera}, new DialogUitl.StringArrayDialogCallback() {
            @Override
