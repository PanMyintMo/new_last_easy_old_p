...
public class ConfigBean {
    ...
    private int mCodeInstallSwitch;
    ...
    @JSONField(name = "codeinstall_switch")
    public int getCodeInstallSwitch() {
        return mCodeInstallSwitch;
    }
    @JSONField(name = "codeinstall_switch")
    public void setCodeInstallSwitch(int codeInstallSwitch) {
        mCodeInstallSwitch = codeInstallSwitch;
    }
