...
public class UserBean implements Parcelable {
    ...
    public UserBean setmIsOpenShop(int mIsOpenShop) {
        this.mIsOpenShop = mIsOpenShop;
        return this;
    }

    public UserBean setmIsOpenPayContent(int mIsOpenPayContent) {
        this.mIsOpenPayContent = mIsOpenPayContent;
        return this;
    }
    ...
    public UserBean setUser_pass(String user_pass) {
        this.user_pass = user_pass;
        return this;
    }

    public UserBean setUser_email(String user_email) {
