            ...
            for (String type : types) {
                ...
                switch (type) {
                    ...
                    case Constants.MOB_TWITTER:
                        ...
                        break;
                    case Constants.MOB_GOOGLE:
                        bean.setIcon1(R.drawable.google);
            ...
            for (String type : types) {
                ...
                switch (type) {
                    ...
                    case Constants.MOB_WX_PYQ:
                        ...
                        break;
                    case Constants.MOB_FACEBOOK:
                        bean.setIcon1(R.mipmap.icon_share_facebook);
                        bean.setIcon2(R.mipmap.icon_share_facebook);
                        break;
                    case Constants.MOB_TWITTER:
                    ...
                    case Constants.MOB_VIBER:
                        bean.setIcon1(R.mipmap.icon_shared_viber);
                        bean.setIcon2(R.mipmap.icon_shared_viber);
                        break;
                    case Constants.MOB_TELEGRAM:
                        bean.setIcon1(R.mipmap.icon_share_telegram);
                        bean.setIcon2(R.mipmap.icon_share_telegram);
                        break;
                    case Constants.MOB_WHATSAPP:
                        bean.setIcon1(R.mipmap.icon_share_whatsapp);
                        bean.setIcon2(R.mipmap.icon_share_whatsapp);
                        break;
                }
                list.add(bean);
            }
