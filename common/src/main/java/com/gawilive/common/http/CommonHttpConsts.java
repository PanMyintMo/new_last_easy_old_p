...
public class CommonHttpConsts {
    ...
    public static final String GET_BALANCE_ORDER = "getBalanceOrder";
    public static final String BALANCE_CALL_BACK = "BalanceCallback";

    public static final String updateIsLive = "updateIsLive";
}
