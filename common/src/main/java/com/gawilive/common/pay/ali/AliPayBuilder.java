package com.gawilive.common.pay.ali;
            ...
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0 && info.length > 0) {
                    ...
                    if (TextUtils.isEmpty(sign)) {
                        ToastUtil.show("The merchant's private key is incorrect and the order signature fails.");
                        return;
                    }
                    sign = urlEncode(sign);
    ...
    private void invokeAliPay() {
        new Thread(new Runnable() {
            ...
            public void run() {
               ...
               // L.e("Alipay returns results----->" + result);
                if (mPayHandler != null) {
