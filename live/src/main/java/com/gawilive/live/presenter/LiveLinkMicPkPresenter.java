...
import com.gawilive.live.custom.ProgressTextView;
...
import com.gawilive.live.socket.SocketLinkMicPkUtil;
import com.gawilive.live.views.LiveLinkMicPkViewHolder;
...
public class LiveLinkMicPkPresenter implements View.OnClickListener {
    ...
    private void nextPkTimeCountDown() {
        ...
        if (mLiveLinkMicPkViewHolder != null) {
            ...
            mLiveLinkMicPkViewHolder.setTime(s + " " + StringUtil.getDurationText2(mPkTimeCount));
        }
    }
