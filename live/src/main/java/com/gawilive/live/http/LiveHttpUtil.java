package com.gawilive.live.http;
...
public class LiveHttpUtil {
    ...
    /**
     * Get the anchor’s banned information
     */
    ...
    /**
     * The anchor obtains the SDK type before starting the broadcast 0 Kingsoft 1 Tencent
     */
    ...
    /**
     * Tencent SDK obtains the low-latency stream of the host when connecting with the host.
     */
    ...
    /**
     *The anchor mixes the stream when the microphone is connected
     */
    ...
    /**
     * Which live broadcast rooms I am the administrator of, return to the list of these live broadcast rooms
     */
    ...
    /**
     * Get the live broadcast room prize pool level
     */
    ...
    /**
     * Check whether the socket connection is normal
     */
    public static void checkSocketConnect(String liveuid,HttpCallback callback) {
    ...
    /**
     * Clear the carousel lottery record
     */
    ...
    /*Get the products on sale in the live broadcast room*/
    ...
    /**
     * Add or remove products for sale in the live broadcast room
     */
    ...
    /**
     * Anchors add and delete platform products for sale in the live broadcast room
     */
    ...
    /**
     * Display or cancel products in the live broadcast room
     */
    ...
    /**
     * Get a list of prop gift stickers
     */
    ...
    /**
     * Add products to the live broadcast room Search for products
     */
    ...
    /**
     * Daily task--Share the live broadcast room
     */
    ...
    /**
     * Voice Chat Room--Application for Microphone
     */
    ...
    /**
     * Voice chat room--cancel application for microphone access
     */
    ...
    /**
     * Voice Chat Room--Get the Wheat application list
     */
    ...
    /**
     * Voice chat room--Users who are on the mic take the initiative to disconnect from the mic.
     */
    ...
    /**
     * Voice chat room--The anchor obtains the microphone control list
     */
    ...
    /**
     *Voice chat room--The anchor or administrator will unplug users who are connected to the microphone.
     */
    ...
    /**
     * Voice chat room--Users on Shangmai obtain the push-pull stream address
     */
    ...
    /**
     * Voice chat room - Maishang users obtain the low-latency streaming addresses of the host in the voice chat room and other Maishang users
     */
    ...
    /**
     * Set up personal center top background image
     */
