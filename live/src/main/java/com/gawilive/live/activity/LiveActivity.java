...
import com.gawilive.common.dialog.LiveChargeDialogFragment;
...
import com.gawilive.game.util.GamePresenter;
import com.gawilive.im.event.ImUnReadCountEvent;
import com.gawilive.im.utils.ImMessageUtil;
import com.gawilive.live.R;
import com.gawilive.live.bean.GlobalGiftBean;
import com.gawilive.live.bean.LiveBean;
import com.gawilive.live.bean.LiveBuyGuardMsgBean;
import com.gawilive.live.bean.LiveChatBean;
import com.gawilive.live.bean.LiveDanMuBean;
import com.gawilive.live.bean.LiveEnterRoomBean;
import com.gawilive.live.bean.LiveGiftPrizePoolWinBean;
import com.gawilive.live.bean.LiveGuardInfo;
import com.gawilive.live.bean.LiveLuckGiftWinBean;
import com.gawilive.live.bean.LiveReceiveGiftBean;
import com.gawilive.live.bean.LiveUserGiftBean;
import com.gawilive.live.bean.LiveVoiceGiftBean;
import com.gawilive.live.bean.LiveVoiceLinkMicBean;
import com.gawilive.live.bean.TurntableGiftBean;
import com.gawilive.live.dialog.DailyTaskDialogFragment;
import com.gawilive.live.dialog.GiftPrizePoolFragment;
import com.gawilive.live.dialog.LiveChatListDialogFragment;
import com.gawilive.live.dialog.LiveChatRoomDialogFragment;
import com.gawilive.live.dialog.LiveGiftDialogFragment;
import com.gawilive.live.dialog.LiveGuardBuyDialogFragment;
import com.gawilive.live.dialog.LiveGuardDialogFragment;
import com.gawilive.live.dialog.LiveInputDialogFragment;
import com.gawilive.live.dialog.LiveRedPackListDialogFragment;
import com.gawilive.live.dialog.LiveRedPackSendDialogFragment;
import com.gawilive.live.dialog.LiveShareDialogFragment;
import com.gawilive.live.dialog.LiveVoiceApplyUpFragment;
import com.gawilive.live.dialog.LuckPanDialogFragment;
import com.gawilive.live.dialog.LuckPanRecordDialogFragment;
import com.gawilive.live.dialog.LuckPanTipDialogFragment;
import com.gawilive.live.dialog.LuckPanWinDialogFragment;
import com.gawilive.live.http.LiveHttpConsts;
import com.gawilive.live.http.LiveHttpUtil;
import com.gawilive.live.presenter.LiveLinkMicAnchorPresenter;
import com.gawilive.live.presenter.LiveLinkMicPkPresenter;
import com.gawilive.live.presenter.LiveLinkMicPresenter;
import com.gawilive.live.socket.SocketChatUtil;
import com.gawilive.live.socket.SocketClient;
import com.gawilive.live.socket.SocketMessageListener;
import com.gawilive.live.socket.SocketVoiceRoomUtil;
import com.gawilive.live.views.AbsLiveViewHolder;
import com.gawilive.live.views.LiveAddImpressViewHolder;
import com.gawilive.live.views.LiveAdminListViewHolder;
import com.gawilive.live.views.LiveContributeViewHolder;
import com.gawilive.live.views.LiveEndViewHolder;
import com.gawilive.live.views.LiveRoomViewHolder;
import com.gawilive.live.views.LiveVoiceLinkMicViewHolder;
import com.gawilive.live.views.LiveWebViewHolder;
...
//        fragment.show(getSupportFragmentManager(), "LiveChatRoomDialogFragment");
        ChatActivity.start(mContext,userBean);
    }
    ...
    public void onImUnReadCountEvent(ImUnReadCountEvent e) {
        String unReadCount = e.getLiveRoomUnReadCount();
    ...
    protected String getImUnReadCount() {
        ...
        return unReadCountArr != null && unReadCountArr.length > 1 ? unReadCountArr[1] : "0";
    }
    ...
    protected void onResume() {
        ...
        if (mAppFrontGroundChanged) {
            ...
            if (mSocketClient != null) {
                LiveHttpUtil.checkSocketConnect(mLiveUid,new HttpCallback() {
                    @Override
                    public void onSuccess(int code, String msg, String[] info) {
                        if (code == 0 && info.length > 0) {
