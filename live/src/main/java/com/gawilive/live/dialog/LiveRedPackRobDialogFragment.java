...
import com.gawilive.live.adapter.RedPackAdapter;
import com.gawilive.live.bean.RedPackBean;
import com.gawilive.live.http.LiveHttpConsts;
import com.gawilive.live.http.LiveHttpUtil;
import com.gawilive.live.interfaces.RedPackCountDownListener;
...
//        mText = mRootView.findViewById(R.id.text);
        ...
        if (mRedPackBean.getSendType() == Constants.RED_PACK_SEND_TIME_DELAY && mRedPackBean.getRobTime() != 0) {
            ...
            if (mCountDown != null) {
                mCountDown.setText(StringUtil.getDurationText2(mRedPackBean.getRobTime()));
            }
...
//        }
    ...
    public void onCountDown(int lastTime) {
        if (lastTime == 0) {
            ...
            if (mCountDown != null) {
                mCountDown.setText(StringUtil.getDurationText2(lastTime));
            }
        }
    }
