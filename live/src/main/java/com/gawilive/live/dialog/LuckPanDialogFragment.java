...
import com.gawilive.live.bean.TurntableConfigBean;
...
public class LuckPanDialogFragment extends AbsDialogFragment implements View.OnClickListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mPrizeIcons[0] = findViewById(R.id.img_0);
        mPrizeIcons[1] = findViewById(R.id.img_1);
        mPrizeIcons[2] = findViewById(R.id.img_2);
        mPrizeIcons[3] = findViewById(R.id.img_3);
        mPrizeIcons[4] = findViewById(R.id.img_4);
        mPrizeIcons[5] = findViewById(R.id.img_5);
        mPrizeIcons[6] = findViewById(R.id.img_6);
        mPrizeIcons[7] = findViewById(R.id.img_7);
        mPrizeNames[0] = findViewById(R.id.name_0);
        mPrizeNames[1] = findViewById(R.id.name_1);
        mPrizeNames[2] = findViewById(R.id.name_2);
        mPrizeNames[3] = findViewById(R.id.name_3);
        mPrizeNames[4] = findViewById(R.id.name_4);
        mPrizeNames[5] = findViewById(R.id.name_5);
        mPrizeNames[6] = findViewById(R.id.name_6);
        mPrizeNames[7] = findViewById(R.id.name_7);
